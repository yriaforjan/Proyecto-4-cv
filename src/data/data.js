  ...
  projects: [
    {
      title: "Yumflix",
      description:
        "A Netflix-inspired recipe platform built with React and Vite. It features an advanced UI with Smart Positioning and Portals for fluid hover-previews, delivering a seamless streaming-like experience using TheMealDB API.",
      tech: ["React", "Vite", "Context API", "Rest API"],
      image: "/images/projects/yumflix.webp",
      github: "https://github.com/yriaforjan/yumflix.git",
      link: "https://yumflix.vercel.app/",
    },
    {
      title: "Retro Videogames RESTful API",
      description:
        "Robust backend API built with Express and MongoDB. Implements a secure RESTful API featuring complete CRUD functionality, an advanced Auth/Roles system (JWT & BCrypt), and seamless Cloudinary integration for full-lifecycle image management (secure upload and automated deletion).",
      tech: [
        "Node.js",
        "Express",
        "Mongo Atlas",
    ...
    },
    {
      ...
      description:
        "Responsive landing page developed with Vite, Tailwind CSS, and modern JavaScript. Features smooth scrolling navigation, parallax effects, and animations powered by Intersection Observer. Additionally, it includes a dynamic news banner that fetches recent relevant updates from a regional news source via RSS.",
      tech: [
        "Vite",
        "JS",
        "Tailwind",
    ...
    },
    {
      title: "PixHive App",
      description:
        "Asynchronous web app built with Vite and modern JavaScript. It uses the Unsplash API to dynamically display high-quality images, featuring pagination and orientation filters. Created for educational purposes to practice API consumption, with a focus on designing a clean and intuitive user interface.",
    ...
    },
    {
      title: "My Portfolio",
      description:
        "My first project using components and focusing on modularization. Built with Vite as a Single Page Application (SPA), it serves as my personal portfolio to showcase all my projects moving forward. The app emphasizes clean, maintainable code structure and responsive design.",
      tech: ["Vite", "JS", "CSS3"],
    ...
    },
    {
      ...
      description:
        "A faithful visual replication of the PcComponentes gallery crafted with HTML, CSS and JavaScript. The project highlights precise DOM manipulation, event handling, and responsive design to accurately reproduce the original user interface experience.",
      tech: ["HTML5", "CSS3", "JS"],
    ...
    },
    {
      ...
      description:
        "A simple web application for managing library books, built with HTML5, JavaScript, and Bootstrap via CDN. Features include adding, viewing, and searching books, as well as importing and exporting data in XML format.",
    ...
    },
    {
      ...
      description:
        "My first complete project built entirely with HTML5 and CSS3. It focuses on semantic markup, accessibility, and clean, modern design. It showcases product offerings with an intuitive layout and smooth user experience.",
      tech: ["HTML5", "CSS3"],
    ...
    },
    {
      ...
      description:
        "My first mini-project, a prototype landing page designed using CSS Flexbox to create a flexible and responsive layout. It highlights mastering layout techniques.",
      tech: ["HTML5", "CSS3"],
